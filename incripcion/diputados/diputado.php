...
<div id="header">
      <ul class="nav">
        ...
        <li><a href="/votacion2/ciudadano/ciudadano.php">Ciudadano</a></li>
         <li><a href="/votacion2/incripcion/diputados/ayuda.php">Ayuda</a></li>
          </ul>
    </div>
  ...
  <div class="row">
         ...
         <div class="col-xs-2">
           ...
           <br> <div class="col-xs-2">
                ...
                <div class="col-xs-2">
                   <select name='coalicion' class="required form-control">
                    <option value="" required ></option>
                        <?php 
                
                            $sql = "SELECT id_cualicion, coalicion FROM cualicion;";
                            $datos = consultaD($con, $sql);
                            foreach ($datos as $value) {
                                print "<option value='";
                                print $value['id_cualicion'];
                                print "'>";
                                print $value['coalicion'];
                                print "</option>";
                            }                
                        ?>
                         </select >
